...
class GameRoomCreate extends AStrategy
{
    ...
    public function exec()
    {
    	...
    	if($room_no) {
    		...
    		$data = Packet::packEncode($data, MainCmd::CMD_SYS, SubCmd::CREATE_ROOM_FAIL_RESP);
    		return $data;
    	} else {
    		// 没有房间，创建房间
    		...
    		$retData = Packet::packEncode($retData, MainCmd::CMD_SYS, SubCmd::CREATE_ROOM_SUCC_RESP);
    		return $retData;
    	}
    }
}